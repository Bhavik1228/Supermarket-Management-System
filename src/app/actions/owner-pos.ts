...
/**
 * Fetch real-time status of all active counters
 * In a real app, this might use WebSockets or a shared state.
 * For now, we simulate by checking recent orders and open sessions.
 */
